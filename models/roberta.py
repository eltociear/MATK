...
class RobertaClassificationModel(pl.LightningModule):
    def __init__(self, model_class_or_path, num_classes=2):
        super().__init__()
        self.save_hyperparameters()
        self.model = RobertaModel.from_pretrained(model_class_or_path)
    ...
    def training_step(self, batch, batch_idx):
        ...
        preds = self.mlp(model_outputs.last_hidden_state[:, 0])
