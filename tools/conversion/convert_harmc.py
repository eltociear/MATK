...
def main(dataset_dir: str, processed_dir: str):
    ...
    train_fp = os.path.join(dataset_dir, "Covid_Dataset", "datasets", "memes", "defaults", "annotations", "train.jsonl")
    test_fp = os.path.join(dataset_dir, "Covid_Dataset", "datasets", "memes", "defaults", "annotations", "test.jsonl")
    val_fp = os.path.join(dataset_dir, "Covid_Dataset", "datasets", "memes", "defaults", "annotations", "val.jsonl")
    
    ## copy images
    img_dir = os.path.join(dataset_dir, "Covid_Dataset", "datasets", "memes", "defaults", "images")
    img_out_dir = os.path.join(processed_dir, "harmc", "images")
    ...
    new_train_fp = os.path.join(processed_dir, "harmc", "annotations", "train.jsonl")
    new_val_fp = os.path.join(processed_dir, "harmc", "annotations", "val.jsonl")
    new_test_fp = os.path.join(processed_dir, "harmc", "annotations", "test.jsonl")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser("Converting Harm-C dataset to specified format")
    parser.add_argument("--dataset-dir", help="Folder path to the Harm-C directory")
    parser.add_argument("--processed-dir", help="Folder path to store the processed Harm-C dataset")
